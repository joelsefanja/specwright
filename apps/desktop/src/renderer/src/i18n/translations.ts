...
export const TRANSLATIONS: Record<Locale, Translations> = {
  nl: {
    ...
    workflow: {
      ...
      steps: {
        "connect-project": { title: "Projectmap kiezen", shortTitle: "Projectmap kiezen", description: "Kies de map van je app. Specwright bewaart de testbestanden daar.", primaryAction: "Projectmap kiezen" },
    ...
    connectProject: { step: "Stap 1", title: "Kies je projectmap", description: "Kies de projectmap waarin Specwright de tests mag opslaan.", openProject: "Projectmap kiezen", preparingProject: "Projectmap wordt gecontroleerd...", changeProject: "Andere map kiezen", selectedFolder: "Gekozen", recentProjects: "Recente projecten", recentDescription: "Ga verder met een project dat je al hebt geopend.", noRecent: "Nog geen projecten. Kies een projectmap om te starten.", whatNext: "Daarna", nextDescription: "Projectmap staat klaar. Voeg nu de app-link toe.", nextButton: "App-link toevoegen", projectFolder: "Projectmap", setupDetails: "Technische details tonen" },
